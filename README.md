...
Há dois arquivos de exemplo de utilização de código que podem ser encontrados em [`exemplo_simplificado.`](./exemplo.vdl) e [`exemplo_avancado.dvl`](./exemplo_avancado.vdl).
